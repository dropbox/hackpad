...
;(function($){
  $.contextMenu = {
    ...
    show: function(t,e) {
      ...
      if (cmenu.beforeShow()!==false) {
        ...
        // XXX: stopPropagation doesn't work with .live handlers, so this fires immediately
        //      luckily, create sets up a handler to do the same thing, so ust comment out for now. -o
  ...
  $.fn.contextMenu = function(menu,options) {
    ...
    */
    $(this).live(cmenu.bindTarget,function(e){cmenu.show(this,e);return false;});
  };
})(jQuery);

...
var padutils = {
  ...
  getIsMobile: function() {
    // TODO: combine with browser data in ace_common
  ...
  isWhitelistUrlScheme: function(url) {
    return padutils.validUrlRe.test(url);
  },
  ...
  tooltip: function(selector) {
    ...
    $(selector).mouseover(function(e) {
      $("#tooltip").remove();
      if (!$(this).attr('data-tooltip') || $(this).hasClass('hp-ui-button-active')) {
        return;
      }
      // TODO: consolidate with other tooltip code.
      var tooltip = $("<div id='tooltip'>").text($(this).attr('data-tooltip')).prependTo($("body"));
      tooltip.css({
        top: $(this).offset().top +
            $(this).outerHeight() + 10,

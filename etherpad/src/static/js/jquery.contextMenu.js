...
var // currently active contextMenu trigger
    ...
    defaults = {
        ...
        position: function(opt, x, y) {
            ...
            if (opt.offsetFunc) {
                offset = opt.offsetFunc(window, offset, opt.$menu.width(), opt.$menu.height());
            } else {
    ...
    op = {
        ...
        layer: function(opt, zIndex) {
            ...
            var $layer = opt.$layer = $('<div id="context-menu-layer" style="position:fixed; z-index:' + zIndex + '; top:0; left:0; opacity: 0; filter: alpha(opacity=0); background-color: #000; width:100%; height:100%;"></div>')
